...
//       deathdate.textContent = `Deathdate: ${prophet.deathdate}`;
...
const displayProphets = (prophets) => {
    prophets.forEach((prophet) => {      
        ...
        fullName.textContent = `${prophet.____} _____________`; 
